...
def retrieve_ship(pk, url):
    ...
    with sqlite3.connect("./shipping.db") as conn:
        ...
        if "_expand" in url:
            ...
            new_query_results = dict(query_result)
            hauler = {
                "id": new_query_results["haulerId"],
                "name": new_query_results["haulerName"],
                "dock_id": new_query_results["dock_id"],
            }
            ship = {
                "id": new_query_results["id"],
                "name": new_query_results["name"],
                "hauler_id": new_query_results["hauler_id"],
                "hauler": hauler,
            }
